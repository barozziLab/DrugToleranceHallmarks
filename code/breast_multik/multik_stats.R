...
mk_res_breast <- readRDS("multik_res_breast_0.1.rds")
res_list <- DiagMultiKPlot_par(ks = mk_res_breast$ks, res_by_k = mk_res_breast$res_by_k, count_vecs = mk_res_breast$count_vecs)
write_tsv(res_list$tog, file = "multik_res_breast_0.1.tsv")