...
# subset reference to only keep variable genes
...
#train
TOSICA.train(ref_1, gmt_path='human_gobp', label_name='author_cell_type', project='A100/hBreast_epithelial_method_1_full')
...
#train
TOSICA.train(ref_2, gmt_path='human_gobp', label_name='author_cell_type', project='A100/hBreast_epithelial_method_2_full')
...
#train
TOSICA.train(ref_3, gmt_path='human_gobp', label_name='author_cell_type', project='A100/hBreast_epithelial_method_3_full')

# PREDICTIONS

# method 1:
model_weight_path = 'A100/hBreast_epithelial_method_1_full/model-9.pth'
predictions_1 = TOSICA.pre(query_1, model_weight_path = model_weight_path, project='A100/hBreast_epithelial_method_1_full')
...
predictions_1.obs.to_csv('A100/predictions_full_1.txt', sep='\t', index=True)

# method 2:
model_weight_path = 'A100/hBreast_epithelial_method_2_full/model-9.pth'
predictions_2 = TOSICA.pre(query_2, model_weight_path = model_weight_path, project='A100/hBreast_epithelial_method_2_full')
...
predictions_2.obs.to_csv('A100/predictions_full_2.txt', sep='\t', index=True)

# method 3:
model_weight_path = 'A100/hBreast_epithelial_method_3_full/model-9.pth'
predictions_3 = TOSICA.pre(query_3, model_weight_path = model_weight_path, project='A100/hBreast_epithelial_method_3_full')
...
predictions_3.obs.to_csv('A100/predictions_full_3.txt', sep='\t', index=True)