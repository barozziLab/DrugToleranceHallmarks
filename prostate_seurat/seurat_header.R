...
pa_up_genes <- read_tsv("data/swne.k=22.exp.MCF7_RM_CD44H.subpop.0.75.MCF7_RM_CD44H_SWNE1_0.75-MCF7_RM_CD44H_others.up.genes.txt", col_names = F) %>%
  pull(X1)
pa_down_genes <- read_tsv("data/swne.k=22.exp.MCF7_RM_CD44H.subpop.0.75.MCF7_RM_CD44H_SWNE1_0.75-MCF7_RM_CD44H_others.down.genes.txt", col_names = F) %>%
  pull(X1)
